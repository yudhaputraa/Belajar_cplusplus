...
int main(){
    ...
    // end : kedua nilai benar utk menghasilkan true
    cout<<"untuk and\n";
    ...
    cout<<"untuk or\n";
    hasil = (a == 3) or (b == 2); // true or true = true
    cout << hasil<<endl;
    hasil = (a == 4) or (b == 2); // false or true = true
    cout << hasil<<endl;
    hasil = (a == 3) || (b == 3); // true or false = true
    cout << hasil<<endl;
    hasil = (a == 4) || (b == 3); // false or false = false
    cout << hasil<<endl;
